function State_DextersLab() {
	...
	_this.Init = function() {
		...
		window.app.view.button_erase = $("#dexterslab #button_erase");
		window.app.view.button_materials = $("#dexterslab #button_materials");
		...
		window.app.view.button_materials.on('click', function() {
		...
		window.app.view.button_erase.on("click", function() {           				window.app.dexterslab.canvas.remove(window.app.dexterslab.canvas.getActiveObject());
																												});
