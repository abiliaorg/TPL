function State_Nursery() {
	...
	_this.Init = function() {
		...
		$("#nursery .sbcgrid_item").on("click", function() {
			...
			if (selecteditem !== undefined) { //I click a color without having clicked an element
				...
				$("#nursery #wrapper_row").css("background-color", color);
				//window.app.view.nursery_nursery.css("z-index", 2);
			}
		})
	...
	function ResizePlayground(){
		...
		var svg = window.app.view.nursery_nursery.find("svg");

		var containerWidth = $("#nursery #wrapper_row").innerWidth();

		var containerHeight = $("#nursery #wrapper_row").innerHeight();
		...
		var width = 0.99*containerWidth;
		var height = width/ratio;

		if(height>containerHeight){
			var height = 0.99*containerHeight;	
